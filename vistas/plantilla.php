...
//si se actualiza la pagina, se eliminen el uid y token

if (file_exists(__DIR__ . "/../vistas/modulos/rfid.txt")) {
    unlink(__DIR__ . "/../vistas/modulos/rfid.txt");
}

if (file_exists(__DIR__ . "/../vistas/modulos/padre_token.txt")) {
    unlink(__DIR__ . "/../vistas/modulos/padre_token.txt");
}
